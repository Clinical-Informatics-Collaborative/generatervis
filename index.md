...
#> + generatervis 0.1.0 → 0.1.0 👷🏿‍♂️🔧 (GitHub: e1e9182)
#> ℹ No downloads are needed, 1 pkg is cached
#> ✔ Got generatervis 0.1.0 (source) (60.58 kB)
#> ℹ Packaging generatervis 0.1.0
#> ✔ Packaged generatervis 0.1.0 (641ms)
#> ℹ Building generatervis 0.1.0
#> ✔ Built generatervis 0.1.0 (884ms)
#> ✔ Installed generatervis 0.1.0 (github::Clinical-Informatics-Collaborative/generatervis@e1e9182) (26ms)
...
This package is written as a part of the Discovery Internship Programme
by the [Research Computing Programme (RCP), Walter and Eliza Hall
