...
#> Empty `.fastq` file created at: /tmp/Rtmp63aPMj/patient_123_smp_001.fastq
#> Populated /tmp/Rtmp63aPMj/patient_123_smp_001.fastq with 2 reads.
sam_file <- paste0(output_dir, "/", patient_id, "_", sample_id, ".sam")
fastq_to_bam(fastq_file, patient_id, sample_id, output_dir, sam_file)
#> Dummy .sam file written to: /tmp/Rtmp63aPMj/patient_123_smp_001.sam 
```
