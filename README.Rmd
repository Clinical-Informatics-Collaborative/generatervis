...
1. Define the patient ID for which you want to plot the FASTQ sequences.
2. Specify the number of reads you want to plot.
3. Optionally, specify the read length (default is 8). It should be multiple of 4.
4. The generated plot will be saved in the current working directory by default. If another directory is specified, the plot will be saved there.
