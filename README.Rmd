...
This package is written as a part of the Discovery Internship Programme by the [Research Computing Programme (RCP), Walter and Eliza Hall Institute of Medical Research](https://wehi-researchcomputing.github.io/), mentored by [Rowland Mosbergen](https://github.com/rowlandm).
